  ...
  return (
    <div className="min-h-screen bg-white flex justify-center items-center mt-20 mb-6">
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <input type="text" name="name" value={formData.name} disabled className="border p-2 rounded w-full bg-gray-200" />
          <input type="text" name="registrationNumber" value={formData.registrationNumber} disabled className="border p-2 rounded w-full bg-gray-200" />
          <input type="email" name="email" value={formData.email} disabled className="border p-2 rounded w-full bg-gray-200" />
          <input type="date" name="foundedDate" value={formData.foundedDate} disabled className="border p-2 rounded w-full bg-gray-200" />
        </div>

        <h3 className="text-lg font-bold mb-4 text-[#225738]">Address</h3>
        <div className="grid grid-cols-2 gap-4 mb-6">
          <input type="text" name="address.city" value={formData.address.city} placeholder="City" onChange={handleChange} className="border p-2 rounded w-full focus:outline-none focus:ring-2 focus:ring-green-600" />
        </div>

        <button type="submit" className="w-full bg-[#225738] text-white font-bold py-2 px-4 rounded hover:bg-green-700" disabled={loading}>
          {loading ? "Updating..." : "Update Profile"}
        </button>
      </form>
    </div>
