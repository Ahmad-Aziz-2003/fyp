...
import GoodnessImage from "../../assets/goodness.jpg";
    ...
    <div style={{ display: "flex", height: "100vh", flexDirection: "column" }}>
      <div
        style={{
          ...
          right: 0,
          bottom: 0,
          backgroundImage: `url(${GoodnessImage})`,
      ...
      >
        <div>
          ...
          >
            <Link to="/ngo-dashboard/createGoodness">
              <button className="px-4 py-2 bg-green-700 text-lg font-bold text-white rounded hover:bg-green-600 transition">
                Create Goodness
              </button>
            </Link>
            <Link to="/ngo-dashboard/editGoodness">
              <button className="px-4 py-2 bg-green-700 text-lg font-bold text-white rounded hover:bg-green-600 transition">
                Edit Goodness
              </button>
            </Link>
            <Link to="/ngo-dashboard/deleteGoodness">
              <button className="px-4 py-2 bg-green-700 text-lg font-bold text-white rounded hover:bg-green-600 transition">
                Delete Goodness
              </button>
            </Link>
